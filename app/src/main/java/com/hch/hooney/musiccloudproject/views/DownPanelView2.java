...
public class DownPanelView2 extends LinearLayout {
    private static final String TAG = DownPanelView2.class.getSimpleName();
    ...
    public DownPanelView2(Context context) {
        super(context);
        isPlay = false;
        setView(context);
    }
